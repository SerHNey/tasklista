...
public class EditTask extends AppCompatActivity implements DatePickerDialog.OnDateSetListener, TimePickerDialog.OnTimeSetListener{
    ...
    public String reqCode_SharedPrefs = "reqCode_sharedPrefs";
    Task i;
    //----------------------------------------------------------date Time
            ...
            addButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if(!(title_text.getText().toString().replaceAll(" ", "").length() == 0)){
                        ...
                        Task newItem = new Task(title_text.getText().toString(), detail_text.getText().toString(), false,dateTime_text.getText().toString(), reqCode);
    ...
    public void setAlarm(Calendar c, int req_code, String title){
        ...
        alarm_intent = new Intent(EditTask.this, MyAlarm.class);
        ...
        pendingIntent = PendingIntent.getBroadcast(EditTask.this, req_code, alarm_intent, PendingIntent.FLAG_UPDATE_CURRENT);
    ...
    public void cancelAlarm(int req_code){
        PendingIntent pen = PendingIntent.getBroadcast(EditTask.this,
